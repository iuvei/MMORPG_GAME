...
#include "scripting/js-bindings/auto/jsb_mlsocket.hpp"
//#include "YuYinImpl.h"
//#include "jsb_yuyinsdk.h"
...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("XYJGame");
#else
        glview = cocos2d::GLViewImpl::createWithRect("XYJGame", Rect(0,0,960,640));
#endif
	...
	sc->addRegisterCallback(register_all_mlsocket);
//	sc->addRegisterCallback(register_all_yuyinsdk);
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID || CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    sc->addRegisterCallback(RegisterFunctions);
#endif
    ...
    sc->enableDebugger();
#endif
//	YuYinImpl::getInstance()->init();
    ScriptEngineProtocol *engine = ScriptingCore::getInstance();
    ScriptEngineManager::getInstance()->setScriptEngine(engine);
    ScriptingCore::getInstance()->runScript("main.js");
#if(CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    SetAppidAndAccesskey();
#endif
    return true;
}
